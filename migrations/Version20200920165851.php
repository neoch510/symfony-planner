 ...
 */
final class Version20200920165851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE planner (id INT AUTO_INCREMENT NOT NULL, social_media_id INT NOT NULL, user_id INT NOT NULL, content LONGTEXT NOT NULL, image LONGTEXT NOT NULL, video VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, date_post DATETIME NOT NULL, INDEX IDX_9551776164AE4959 (social_media_id), INDEX IDX_95517761A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
